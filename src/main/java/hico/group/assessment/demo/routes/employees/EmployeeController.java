...
public class EmployeeController {
    ...
    @ResponseBody
    @PostMapping(value = "/api/employees", produces = "application/json")
    ...
    @ResponseBody
    @GetMapping(value = "/api/employee/{id}", produces = "application/json")
    public Employees getEmployeeById(@PathVariable Long id) {
        return employeeRepository.findById(id).orElseThrow(() -> new EmployeeNotFoundException(id));
    }

    @ResponseBody
    @PatchMapping(value = "/api/employee/{id}", produces = "application/json")
    ...
    @ResponseBody
    @DeleteMapping(value = "/api/employee/{id}", produces = "application/json")
